...
import com.ubiqube.parser.tosca.objects.tosca.policies.nfv.DataFlowInfo;
...
import com.ubiqube.parser.tosca.objects.tosca.policies.nfv.VipCpInitialDelta;
import com.ubiqube.parser.tosca.objects.tosca.policies.nfv.VipCpInstantiationLevels;
import com.ubiqube.parser.tosca.objects.tosca.policies.nfv.VipCpScalingAspectDeltas;
...
public interface PolicyMapper {
	...
	DataFlowInfo mapToDataFlowInfo(tosca.policies.nfv.DataFlowInfo o);
	...
	VipCpScalingAspectDeltas mapToVipCpScalingAspectDeltas(
			tosca.policies.nfv.VipCpScalingAspectDeltas o);

	VipCpInitialDelta mapToVipCpInitialDelta(tosca.policies.nfv.VipCpInitialDelta o);

	VipCpInstantiationLevels mapToVipCpInstantiationLevels(
			tosca.policies.nfv.VipCpInstantiationLevels o);
}
