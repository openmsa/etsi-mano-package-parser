...
public class VipCpInitialDelta {
	/**
	...
	private VipCpLevel initialDelta;

	@Valid
	private List<String> targets;

	@NotNull
	public VipCpLevel getInitialDelta() {
		return this.initialDelta;
	}

	public void setInitialDelta(@NotNull final VipCpLevel initialDelta) {
